                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            foreach ($FIELD_FORM as $form) : ?>
                                ...
                                if ($modal_edit     && $isHideFromEdit)     continue;
                                if (!$modal_edit    && $ishideFromCreate)   continue;
                            ...
                            <?php endif ?>
                                ...
                                <?php if ($addButton) : ?>
                                    <div class="mt-1 col-sm-1">
                                        <br>
                                        <button type='button' class='btn float-right btn-danger' onclick='showModalAddSelect("<?= $URL_GET_MODAL . $form["name"] ?>")'><i class='fas fa-plus'></i></button>
                                    </div>
                                <?php endif ?>
