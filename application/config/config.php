...
$config['base_url'] = ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : ((isset($_SERVER['HTTP_X_FORWARDED_SCHEME']) && $_SERVER['HTTP_X_FORWARDED_SCHEME'] == "https") ? "https" : "http"));
...
$config['sess_cookie_name']         = 'RFLSIPEGIATCOOKIE';
